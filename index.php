...
<html lang="en-US">
<head>
	<title>Asia: салон красоты</title>
	<meta charset="UTF-8">
					...
					<div class="b1-right">
						...
						<div class="b1-form">
							<form action="" class="b1-f1">
								<label for="f-name" class="b1-lab">Записаться на <span>БЕСПЛАТНУЮ</span> консультацию стилиста</label>
								<input type="text" name="name" class="f-name" placeholder="Ваше имя">
								<input type="text" name="phone" class="f-phone" placeholder="Ваш телефон">
								<button type="submit" class="btn-f1">Отправить</button>
			...
			<div class="col-xl-12">
				<div class="wrap-b2">
					...
					<div class="wrap-advantages">
						<div class="advantage">
							<div class="adv-icon">
								<img src="/img/icons/ico-1.png" alt="">
							</div>
							<p>Экономия Вашего<br> времени</p>
							<p>Предлагаем Вам услугу<br> "работа в 4 руки".<br> Так вы экономите свое<br> время почти в  2 раза...</p>
						</div>

						<div class="advantage">
							<div class="adv-icon">
								<img src="/img/icons/ico-2.png" alt="">
							</div>
							<p>Безопасность <br>и гигиена</p>
							<p>Одноразовые расходники, <br>стерилизация инструментов,<br>использование крафтовых<br>пакетов.</p>
						</div>

						<div class="advantage">
							<div class="adv-icon">
								<img src="/img/icons/ico-3.png" alt="">
							</div>
							<p>Качественные материалы<br>мировых брендов</p>
							<p>OPI, Beautix, Kodi, UNO,<br>BI NATURAL, CND, VINILUX,<br>Tartiso, Cosmo, Safia,<br>Masura, Inoar, Gloria и др.</p>
						</div>

						<div class="advantage">
							<div class="adv-icon">
								<img src="/img/icons/ico-4.png" alt="">
							</div>
							<p>Профессиональная<br>команда</p>
							<p>Все мастера Asia Studio - это<br>сертифицированные <br>специалисты <br>с многолетним опытом</p>
						</div>
						...
						<div class="advantage">
							...
							<p>Дружелюбная<br>атмосфера</p>
							<p>Для Вас мы с удовольствием <br>приготовим чашечку <br>кофе/чая и обязательно <br>угостим сладостями :)</p>
						</div>
					</div>
				</div>
			</div>
...
<div class="bg-paporotnik"></div>
<section class="shellac">
	<div class="container">
		<div class="row">
			<div class="col-xl-9">
...
<div class="bg-flowers-1"></div>
<div class="bg-legs"></div>
	<div class="container">
		<div class="row">
			<div class="col-xl-12">
...
<section id="konsul">
<div class="bg-konsul-1"></div>
<div class="bg-konsul-2"></div>
	<div class="container">
		<div class="row">
			<div class="col-xl-8 ml-auto">
				<div class="wrap-konsul">
					...
					<form action="" class="form-2">
						<input type="text" name="name" class="f2-name" placeholder="Ваше имя">
						<input type="text" name="phone" class="f2-phone" placeholder="Ваш телефон">
						<button type="submit" class="btn-f1">Отправить</button>
		...
		<div class="row">
			<div class="col-xl-12">
				<div class="maki">
					...
					<div class="maki-p-2">
						<p>Легкий дневной макияж:<span>от 600 руб.</span></p>
					...
					<div class="uslugi">
						<div class="usluga">
							...
							<div class="maki-p-2">
								...
								<p>Вечерние прически:<span>от 800 руб</span></p>
							</div>
						</div>
						...
						<div class="usluga">
							...
							<div class="maki-p-2">
								...
								<p>Стрижка челки:<span>300 руб</span></p>
							</div>
						</div>
